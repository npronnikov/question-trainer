...
- `backend/src/main/resources/prompts/practice-assessment-v3.md` — активная оценка трёх полей и потенциала идеи
- `backend/src/main/resources/prompts/practice-assessment-v2.md` и `practice-assessment-v1.md` — legacy-схемы для чтения истории
...
- `GET /api/practice/idea-progress` — персональная динамика потенциала идей по категориям и завершённым циклам
