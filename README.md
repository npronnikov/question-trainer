...
2. **Офлайн-тренажёр** — 28 ситуаций, четыре варианта ответа, переворот карточки, очки и серия правильных ответов. Прогресс хранится в `localStorage`; после первого открытия теория и тренажёр работают без сети.
